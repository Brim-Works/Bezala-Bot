...
class CardMatchingEndpointsTest(unittest.TestCase):
    ...
    def test_match_to_bezala_attaches_file_and_updates_db(self):
        ...
        # attach_file ska ha anropats med det rätta tx_id:t
        fake_bezala.attach_file.assert_called_once()
        args = fake_bezala.attach_file.call_args.args
        self.assertEqual(args[0], "12345")  # transaction_id
        self.assertEqual(args[1], "20260414 Anthropic API.pdf")  # filename
